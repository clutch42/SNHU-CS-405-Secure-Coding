...
// function to display results for overflow tests
// takes the result and start as arguments
// and returns nothing
template <typename T>
void displayOverflowResults(const T &result, const T &start) {
    if (result != start) {
...
// function to display results for underflow tests
// takes the result and start as arguments
// and returns nothing
template <typename T>
void displayUnderflowResults(const T &result, const T &start) {
    if (result != start) {
        std::cout << +result << std::endl;
    }
    else {
...
void test_overflow()
{
    ...
    displayOverflowResults(result, start);
...
void test_underflow()
{
    ...
    displayUnderflowResults(result, start);
